...
<gr:layout title="Ajouter des personnes">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card">
						...
						<form class="form" role="form" action="/ProjetSpring/admin/personne/addPersonne" method="post"
											...
											<div class="col-md-6">
												<div class="form-group floating-label">
													<input name="nom" type="text" class="form-control input-lg"
														id="firstname"> <label for="firstname">Nom</label>
												</div>
											</div>
											<!--end .col -->
											<div class="col-md-6">
												<div class="form-group floating-label">
													<input name="prenom" type="text"
														class="form-control input-lg" id="lastname"> <label
									...
									<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<input name="tel" type="text" class="form-control"
															id="mobile"> <label for="mobile">N°Tel</label>
													</div>
												</div>
												<!--end .col -->
												...
												<div class="col-md-8">
													<div class="form-group">
														<input name="cin" type="text" class="form-control"
															id="street"> <label for="street">CIN</label>
													</div>
												</div>
												<!--end .col -->
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input name="photo" id="uploadImage" type="file" name="myPhoto" onchange="PreviewImage();" />
